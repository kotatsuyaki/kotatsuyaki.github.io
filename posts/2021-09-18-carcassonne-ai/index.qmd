...
![Game interface written with Flutter, a by-product of this project](Screenshot_20210918_215801.png){width=60%}
...
![The CSV file used to generate boilerplate code](Screenshot_20210918_225354.png)
...
![The search tree with two types of nodes](dutree.svg){width=50%}
...
![Simple indirection may save the day](indir.svg){width=60%}
