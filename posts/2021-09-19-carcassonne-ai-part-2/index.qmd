...
![My poor man's single-machine AlphaZero architecture](batch.svg)
...
![Grid-like graph structure for othello used in their work.](othello-graph.png){width=50%}
...
![My current network diagram. Selfloops represent repetitions.](network.svg)
...
- A global _add_ pool with several dense layers (and a sigmoid at the end) as the value head.
  ...
  ![Summation is more expressive when classifying graphs.](x3.png)
